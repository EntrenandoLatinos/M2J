...
class Counter(AuditoriaFecha):
    title1 = models.CharField("Title 1", max_length=100, null=True, blank=True)
    number1 = models.IntegerField("Number 1", null=True, blank=True)
    title2 = models.CharField("Title 2", max_length=100, null=True, blank=True)
    number2 = models.IntegerField("Number 2", null=True, blank=True)
    title3 = models.CharField("Title 3", max_length=100, null=True, blank=True)
...
class WorkImage(AuditoriaFecha):
    ...
    title = models.CharField("Image title", max_length=150, null=True, blank=True)
...
class Testimonial(AuditoriaFecha):
    ...
    location = models.CharField("Location", max_length=150, null=True, blank=True)
    description = models.TextField("Description", null=True, blank=True)
...
class SocialMedia(AuditoriaFecha):
    ...
    link_class = models.CharField("a href class", max_length=150)
